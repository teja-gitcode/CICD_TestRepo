...
SVC_NAME=`systemd-escape --path "vsts.agent.ashleyfurniture.MFG-EdgeAIML_arm64.Jetson_agx_cartloading.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (ashleyfurniture.MFG-EdgeAIML_arm64.Jetson_agx_cartloading)"
